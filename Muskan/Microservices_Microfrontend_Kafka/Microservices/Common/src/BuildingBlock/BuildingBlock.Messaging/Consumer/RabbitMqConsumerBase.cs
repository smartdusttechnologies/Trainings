...
namespace BuildingBlock.Messaging.Consumer
{
     public class RabbitMqConsumerBackgroundService : BackgroundService
     {
          ...
          private readonly string _exchange = "log-entry-exchange";
          private readonly string _queue = "log-entry-queue";
               ...
               try
               {
                    ...
                    consumer.ReceivedAsync += async (model, ea) =>
                    {
                         try
                         {
                              ...
                              var message = JsonSerializer.Deserialize<LogEntryMessage>(json);
          ...
          // Corrected Signature
          protected virtual Task HandleMessageAsync(LogEntryMessage message, CancellationToken cancellationToken)
          {
