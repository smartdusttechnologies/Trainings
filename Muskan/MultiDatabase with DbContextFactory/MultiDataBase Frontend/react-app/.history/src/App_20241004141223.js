...
const App = () => {
  ...
  const handleDelete = (id) => {
    axios
      ...
      .then((response) => {
        // Assuming the response is successful and you don't need the deleted employee data
        const updatedData = data.filter((user) => user.id !== id); // Remove the deleted employee from state
        setData(updatedData);
      })
      .catch((error) => {
