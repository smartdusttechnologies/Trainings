...
# First Upload (1000 PDFs)
upload_files_first = st.sidebar.file_uploader("Upload 1000 Resumes", type=["pdf"], accept_multiple_files=True)
if upload_files_first:
    ...
    # Save resumes to respective category folders
...
# Second Upload (500 PDFs)
if 'selected_category' in st.session_state:
    st.sidebar.header("Upload 500 Resumes for Selected Category")
    upload_files_second = st.sidebar.file_uploader(f"Upload 500 Resumes for Category: {st.session_state.selected_category}",
