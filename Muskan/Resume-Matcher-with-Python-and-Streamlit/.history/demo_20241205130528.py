...
if red == "Home":
    ...
    # Sidebar multiselect to choose columns for plotting
    col = st.sidebar.multiselect("Select columns to plot", df.columns)
    ...
    for i in range(100):
        time.sleep(0.01)  # Simulate a task
        progress.progress(i + 1)
    
    st.balloons()  # Trigger balloons after task completion
    st.success("Task completed successfully!")

    # Display some information messages
