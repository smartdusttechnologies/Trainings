namespace Shopping.Web.Models.Ordering
{
    ...
    public record AddressModel(string FirstName, string LastName, string EmailAdress, string AdressLine, string Country, string State, string ZipCode);

    public record PaymentModel(string CardName, string CardNumber, string ExpiryDate, string Cvv, int PaymentMethod);
