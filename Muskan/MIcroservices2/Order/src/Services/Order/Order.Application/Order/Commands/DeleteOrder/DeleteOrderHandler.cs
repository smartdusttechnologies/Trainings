...
namespace Ordering.Application.Order.Commands.DeleteOrder
{
     ...
     /// </summary>
     public class DeleteOrderHandler(IApplicationDbContext context, ILoggingService<DeleteOrderHandler> logger) : ICommandHandler<DeleteOrderCommand, DeleteOrderResult>
     {
          /// <summary>
