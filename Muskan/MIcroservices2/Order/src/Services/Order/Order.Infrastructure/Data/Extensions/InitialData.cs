namespace Ordering.Infrastructure.Data.Extensions
{
    public class InitialData
    {
      ...
      new List<Customer>
      {
        ...
        Customer.Create(CustomerId.Of(new Guid("789dc832-990f-48e0-a37b-e6f2b60b9d7d")), "harry", "harry@gmail.com") // Fixed GUID
       };
        ...
        public static IEnumerable<Orders> OrdersWithItem
        {
            get
            {
                ...
                var address3 = Address.Of("harry", "poter", "harry@gmail.com", "Bihar No:9", "India", "Bihar", "801105");

                var payment1 = Payment.Of("mehmet", "5555555555554444", "12/28", "355", 1);
                var payment2 = Payment.Of("john",  "8885555555554444", "06/30", "222", 2);
                var payment3 = Payment.Of("harry", "8885555555554456", "07/30", "232", 3);

                var order1 = Orders.Create(
                ...
                var order3 = Orders.Create(
                            OrderId.Of(Guid.NewGuid()),
                            CustomerId.Of(new Guid("789dc832-990f-48e0-a37b-e6f2b60b9d7d")), // Fixed GUID
                            OrderName.Of("ORD_003"),
                            shippingAdress: address3,
                            billingAdress: address3,
                            payment3);
                order3.Add(ProductId.Of(new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61")), 1, 650);
                order3.Add(ProductId.Of(new Guid("6ec1297b-ec0a-4aa1-be25-6726e3b51a27")), 2, 450);

                return new List<Orders> { order1, order2, order3 };
            }
        }
    }
}
