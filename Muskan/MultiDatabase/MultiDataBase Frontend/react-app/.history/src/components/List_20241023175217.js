              ...
              <td>
                ...
                {user.file && (
                  <>
                    {/* Display the image */}
                    <img
                      src={`https://localhost:7122/api/Employee/${user.id}/download`} // Fixed user id interpolation
                      alt="User File"
                    ...
                    <button
                      ...
                      onClick={() => handleDownload(user.id)} // Pass user id to handleDownload
                      style={{ marginLeft: "10px" }} // Space between image and button
                    >
                      Download
                    </button>
                  </>
